...
class User(Base):
    ...
    activity_level: Mapped[str] = mapped_column(String(16), nullable=False, default="moderate", server_default="moderate")

    language_code: Mapped[str | None] = mapped_column(String(16), nullable=True)
    locale: Mapped[str] = mapped_column(String(8), nullable=False, default="ru", server_default="ru")
    timezone: Mapped[str | None] = mapped_column(String(64), nullable=True)
    onboarding_done: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, server_default="false")
